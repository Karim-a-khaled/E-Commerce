...
namespace PartTwo.WebAPI.ExtensionMethods;

public static class UserManagerExtensions
{
    public static async Task<AppUser> FindUserByClaimsPricipleWithAddress(this UserManager<AppUser> userManager, ClaimsPrincipal user)
    {
